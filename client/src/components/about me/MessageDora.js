...
import "./messagedora.css"

const MessageDora = () => {
  return (
    <div className="message-dora">
    <div className="co">
      <div className="message-dora-co">
        <div className="message-dora-co">
        ...
        <iframe className="message-video" src="https://www.youtube.com/embed/VeSApPYcCBM" frameborder="0" title='video'  allow="autoplay; encrypted-media" allowFullScreen></iframe>
      </div>
    </div>
  </div>
  )
